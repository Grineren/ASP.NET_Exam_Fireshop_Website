...
public partial class Tilbehor : System.Web.UI.Page
{
    ...
    {
        Repeater_Maerke.DataSource = db.Maerkes.Where(m => m.Fk_KategoriId.Equals(2));
        ...
        if (Request.QueryString["vare_id"] != null)
        {
            ...
            Repeater_EnkeltVareMaerkeHeader.DataSource = db.Vares.Where(v => v.V_Id.Equals(querystring));
            Repeater_EnkeltVareMaerkeHeader.DataBind();
    ...
    public string HentBilledeStiOgNavn(int repeaterindex)
    {
        ...
        if (query.ToList()[repeaterindex].Fk_BilledeId != 0)
        {
            ...
            string result = @"<img src='../Billeder/Resized/" + billedeUrl + "' alt='Billede' class='paddingTop20px' style=' max-height: 200px; max-width: 200px;'  /> ";
            //
            return result;
        }
        else
    ...
    public string HentBilledeStiOgNavnEnkelt(int repeaterindex)
    {
        ...
        if (query.ToList()[repeaterindex].Fk_BilledeId != 0)
        {
            ...
            string result = @"<img src='../Billeder/Resized/" + billedeUrl + "' alt='Billede' style=' max-height: 200px; max-width: 200px;'  /> ";
